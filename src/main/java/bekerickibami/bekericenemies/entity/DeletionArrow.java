...
public class DeletionArrow extends EntityArrow {
    public DeletionArrow(World worldIn) {
        super(worldIn);
        this.pickupStatus = PickupStatus.DISALLOWED;
    }

    public DeletionArrow(World worldIn, double x, double y, double z) {
        this(worldIn);
        this.setPosition(x, y, z);
    }

    public DeletionArrow(World worldIn, EntityLivingBase shooter) {
        ...
        if (entity != null) {
            ...
            if (!this.world.isRemote && !entity.equals(this.shootingEntity)) {
                if (entity instanceof EntityDragon) {
                    ...
                    ((EntityDragon) entity).deathTicks = 199;
                } else {
                    entity.setDead();
                }
                this.setDead();
